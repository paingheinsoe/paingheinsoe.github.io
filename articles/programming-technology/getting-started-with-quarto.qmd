...
![The official Quarto download page for Windows.](../../images/quarto/download-quarto.png){fig-alt="Quarto download webpage showing the Windows installer" width="90%" fig-align="center"}
...
![The official Visual Studio Code download page.](../../images/quarto/download-vscode.png){fig-alt="Visual Studio Code download webpage with Windows, Linux, and Mac options" width="90%" fig-align="center"}
...
![Recommended workspace for Quarto projects.](../../images/quarto/folder-structure.png){width="85%" fig-align="center"}
...
![Navigate to the project folder using PowerShell.](../../images/quarto/powershell-cd.png){width="90%" fig-align="center"}
...
![Creating the Quarto website project.](../../images/quarto/quarto-create.png){width="90%" fig-align="center"}
...
![The Quarto website project opened in Visual Studio Code.](../../images/quarto/website-files.png){width="90%" fig-align="center"}
...
![The default Quarto website running locally in the browser.](../../images/quarto/browser-preview-default.png){width="90%" fig-align="center"}
...
![The personalized homepage after editing `index.qmd`.](../../images/quarto/browser-preview-personalized.png){width="90%" fig-align="center"}
